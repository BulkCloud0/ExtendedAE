...
public class REIPlugin implements REIClientPlugin {
    ...
    public void registerCategories(CategoryRegistry registry) {
        ...
        registry.addWorkstations(ChargerDisplay.ID, EntryStacks.of(EPPItemAndBlock.EX_CHARGER));
        registry.addWorkstations(Ae2ReflectClient.getInscribeRecipeREI(), EntryStacks.of(EPPItemAndBlock.EX_INSCRIBER));
    }
